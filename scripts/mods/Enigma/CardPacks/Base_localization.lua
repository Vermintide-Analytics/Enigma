return {
    ...
    base_eshin_counter_intelligence_description = {
        en = "Gain immunity to assassins"
    },
    ...
    base_soul_safe_description = {
        en = "Gain immunity to life-leeches"
    },
    ...
    base_harness_discord_description = {
        en = "Slow down time of the world around you by %.f%%.\n%+.f%% Duration for each Dormant Crystal in your hand.\nActivate Dormant Crystals in your hand for the duration of this effect."
    },
    ...
    base_ubersreik_hero_condition = {
        en = "An ally is disabled"
    },
    ...
    base_warpfire_strikes_description = {
        en = "Your melee attacks ignite enemies"
    },
