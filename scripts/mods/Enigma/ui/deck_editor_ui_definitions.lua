...
local LEFT_PANEL_WIDTH = INNER_WINDOW_WIDTH*0.35
...
local PAGINATION_PANEL_WIDTH = RIGHT_PANEL_WIDTH*0.25
...
local CARD_TILE_HEIGHT = (RIGHT_PANEL_HEIGHT - PRETTY_MARGIN*(CARD_TILE_ROWS+1))/CARD_TILE_ROWS / 1.05
...
local define_card_tile_widget = function(scenegraph_id, tile_index)
	...
	local vertical_offset = PRETTY_MARGIN*row + CARD_TILE_HEIGHT*(row - 1)*1.04 + CARD_TILE_HEIGHT*0.04
